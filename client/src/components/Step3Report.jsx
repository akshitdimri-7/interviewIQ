      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        <div className="space-y-6">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-white riunded-2xl sm:rounded-3xl shadow-lg p-6 sm:p-8 text-center"
          >
            ...
            <div className="space-y-5">
              {skills.map((s, i) => (
                <div key={i}>
                  ...
                  <div className="bg-gray-200 h-2 sm:h-3 rounded-full"></div>
                  <div
                    className="bg-green-500-200 h-full rounded-full"
          ...
          >
            ...
            <div className="space-y-6">
              {questionWiseScore.map((q, i) => (
                <div
                  key={i}
                  className="bg-gray-50 p- sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200"
                >
                  ...
                  <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                      {q.feedback && q.feedback.trim() !== ""
                        ? q.feedback
                        : "No feedback availbale for this question."}
                    </p>
                  </div>
                </div>
              ))}
