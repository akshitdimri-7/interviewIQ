...
const Step1Setup = ({ onStart }) => {
  ...
  const handleUploadResume = async () => {
    ...
    const formData = new FormData.append("resume", resumeFile);
  ...
  const handleStart = async () => {
    ...
    try {
      const result = await axios.post(
        ...
        { role, experience, resumeText, projects, skills },
        { withCredentials: true },
      );
      ...
      if (userData) {
        dispatch(
          setUserData({ ...userData, credits: result.data.creditsLesft }),
        );
      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        ...
        >
          ...
          <p className="text-gray-600 mb-10">
            ...
            Improve communication, technical skills, ans confidence.
          </p>
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Experience...(ex: 2yrs...)"
                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition"
            ...
            {!analysisDone && (
              <motion.div
                ...
                className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-green-500 hover:bg-green-50 transitione"
              >
